...
INSERT INTO Employees1 (EmpID, FirstName, LastName, Email, DepartmentName, Salary)
VALUES
(1, 'Ali', 'Karimov', 'ali.karimov@example.com', 'HR', 65000),
(2, 'Aziza', 'Rustamova', NULL, 'Finance', 72000),
(3, 'Jasur', 'Tursunov', 'jasur.t@example.com', 'HR', 58000),
(4, 'Malika', 'Usmonova', NULL, 'IT', 80000),
(5, 'Anvar', 'Saidov', 'anvar.s@example.com', 'Marketing', 60000);
...
FROM Orders
WHERE OrderDate 
      BETWEEN DATEADD(DAY, -180, LATEST_DATE) 
          AND LATEST_DATE;
