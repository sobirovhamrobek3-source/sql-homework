...
outer apply
(
select CustomerID, orderID, productID, orderDate, quantity,TotalAmount from [orders] o
where O.customerID = c.customerID) as a
...
SELECT d.DepartmentName, x.MaxSalary
FROM Departments d
OUTER APPLY (
...
select  c.firstName as customerName, max(o.OrderDate) as MostRecentOrderDate
		from Customers c
		left join Orders o
...
or s.SaleAmount > 350.00

select c.categoryname,count (p.productID) as productCount
	from Products p
	left join Categories c
	on c.CategoryID = p.supplierID
...
select c.Firstname+ ' '+c.LastName as customerName,
 ...
 select e.name,d.DepartmentName
	...
	and e.Name like '%[a,i,e,o,u]%[a,i,e,o,u]%[a,i,e,o,u]%[a,i,e,o,u]%'
